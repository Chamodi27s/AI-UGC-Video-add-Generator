...
export default function Hero() {
    ...
    const trustedUserImages = [
        'https://media.istockphoto.com/id/2223853412/photo/group-of-professionals-engaging-in-a-team-meeting-in-a-modern-environment.webp?a=1&b=1&s=612x612&w=0&k=20&c=JBNpRwbBGuPFxjv4ftutngFqq3RdkApj-4Y4dTvxibA=',
        'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=50',
        'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=50&h=50&fit=crop'
    ];

    const mainImageUrl = 'https://plus.unsplash.com/premium_photo-1661440352320-c7ddd4b52185?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8b2ZmaWNlJTIwbWVldGluZ3xlbnwwfHwwfHx8MA%3D%3D';

    const galleryStripImages = [
        'https://media.istockphoto.com/id/2223853412/photo/group-of-professionals-engaging-in-a-team-meeting-in-a-modern-environment.webp?a=1&b=1&s=612x612&w=0&k=20&c=JBNpRwbBGuPFxjv4ftutngFqq3RdkApj-4Y4dTvxibA=',
        'https://media.istockphoto.com/id/2203914027/photo/business-professional-leading-team-presentation-in-modern-office-setting.webp?a=1&b=1&s=612x612&w=0&k=20&c=oV-EUb7LGiU_C_4iPb_NiAhLnVsk_JKXOKs7xIrrl9Q=',
        'https://media.istockphoto.com/id/2184773448/photo/overhead-shot-of-business-panel-in-office-meeting-collaborating-around-large-table.jpg?s=612x612&w=0&k=20&c=NzQ7IQQnvvj8Z9K8iOw0I6kK6rX24PyoloIgQIEtAGc=',
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and a model photo - our AI instantly produces professional lifestyle and short-form videos optimized for commercials & Reels.
                            </motion.p>
