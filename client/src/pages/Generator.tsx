...
const Generator = () => {
    ...
    const handleGeanerate =async(e: React.FormEvent<HTMLFormElement>) =>{
      e.preventDefault();
    }
  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit = {handleGeanerate} className="max-w-4xl mx-auto mb-40">
      ...
      <div className="flex gap-20 max-sm:flex-col items-start justify-between">
        {/* Left Col */}
        <div className="flex flex-col w-full sm:max-w-60 gp-8 mt-8 mb-12">
